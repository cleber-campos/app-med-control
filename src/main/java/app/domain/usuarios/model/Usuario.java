package app.domain.usuarios.model;
...
public class Usuario implements UserDetails {
    ...
    public Usuario(UsuarioRequestCreateDTO usuarioRequestCreateDTO) {
        this.login = usuarioRequestCreateDTO.login();
        this.senha = usuarioRequestCreateDTO.senha();
        this.status = true;
        this.dataHoraInclusao = LocalDateTime.now();
    }

    public void atualizaDados(UsuarioRequestUpdateDTO usuarioUpdateDTO) {
